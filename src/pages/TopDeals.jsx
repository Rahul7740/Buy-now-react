            ...
            <div className="products-view-all-contianer">
              ...
              <div className="topDeal-top-Products-container">
                <div className="topDeal-top-Products-1">
                  <div>
                    <h3>Jabra (Wireless Headsets) <span style={{ color: "#422659" }}>20% off</span></h3>
                    <p>$ 600.00</p>
                    <AllButtons name="BUY NOW" />
                  </div>
                  <img src={require('../assets/images/topDeal-img-1.png')} alt="top" />
                </div>
                <div className=" topProduct-2 topDeal-top-Products-1">
                  ...
                  <img src={require('../assets/images/topDeal-img-2.png')} alt="top" />
                </div>
              </div>
